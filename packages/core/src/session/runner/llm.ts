        ...
        system: [
          ...
          contract?.status === "active"
            ? [
                ...
                "For behavior-matching work, enumerate documented surfaces, boundary and error semantics, and material interactions. Use batched differential probes with finite per-case deadlines, then preserve observations as regression checks after coherent edits; delivery replay alone is not a behavioral stopping condition.",
