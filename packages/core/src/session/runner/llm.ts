        ...
        system: [
          ...
          contract?.status === "active"
            ? [
                ...
                "For behavior-matching work, enumerate documented surfaces and material interactions, then use bounded batched differential probes against the available oracle. Preserve those observations as regression checks after coherent edits; delivery replay alone is not a behavioral stopping condition.",
